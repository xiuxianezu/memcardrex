...
namespace MemcardRex.Linux
{
    public class SaveCompare
    {
        ...
        {
            _data = data;
            var builder = Localization.Builder("MemcardRex.Linux.GUI.SaveCompare.ui");
            ...
            if (builder.GetObject("LabelSave1") is Label label1)
                label1.SetText($"{Localization.T("Save 1: ")}{save1Name}");

            if (builder.GetObject("LabelSave2") is Label label2)
                label2.SetText($"{Localization.T("Save 2: ")}{save2Name}");
        ...
        private void SetupColumns()
        {
            ...
            string[] titles = { Localization.T("Offset (hex, int)"), Localization.T("Save 1 (hex, int)"), Localization.T("Save 2 (hex, int)") };
